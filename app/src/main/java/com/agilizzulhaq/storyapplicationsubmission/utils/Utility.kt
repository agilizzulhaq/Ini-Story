package com.agilizzulhaq.storyapplicationsubmission.utils
...
fun Bitmap.getRotatedBitmap(file: File): Bitmap {
    return when (ExifInterface(file).getAttributeInt(ExifInterface.TAG_ORIENTATION, ExifInterface.ORIENTATION_UNDEFINED)) {
